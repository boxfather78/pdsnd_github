...
nanodegree. In completing the code, I have referenced a number of websites to support coding build. This includes Stack Overflow, GeeksforGeeks and the Python package library. Much of this was to discover new methods/libraries or understand how to use the arguments within a particular method or function."""
